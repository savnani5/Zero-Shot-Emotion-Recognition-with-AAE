...
class Gzsl_vae():
	...
	def train_classifier(self,epochs):
		...
		self.cls_trainloader = data.DataLoader(self.cls_trainData, batch_size=6, shuffle=True)
		...
		self.cls_test_unseenLoader = data.DataLoader(self.cls_test_unseen, batch_size=6, shuffle=False)
		...
		self.cls_test_seenLoader = data.DataLoader(self.cls_test_seen, batch_size=6, shuffle=False)
