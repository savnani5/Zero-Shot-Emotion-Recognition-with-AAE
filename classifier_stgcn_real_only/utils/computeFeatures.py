import numpy as np
from utils.util_zsl import angle_between
from utils.util_zsl import distance_between
from utils.util_zsl import area_triangle
...
def computeFeatures(frames):
	...
	# Speeds
	features.append(computeFeature12(frames, 0.1))
	features.append(computeFeature13(frames, 0.1))
	features.append(computeFeature14(frames, 0.1))
	# features.append(computeFeature15(frames, timestep))
	# features.append(computeFeature16(frames, timestep))
	# Accelerations
	features.append(computeFeature17(frames, 0.1))
	features.append(computeFeature18(frames, 0.1))
	features.append(computeFeature19(frames, 0.1))
	# features.append(computeFeature20(frames, timestep))
	# features.append(computeFeature21(frames, timestep))
	# Movement Jerk
	features.append(computeFeature22(frames, 0.1))
	features.append(computeFeature23(frames, 0.1))
	features.append(computeFeature24(frames, 0.1))
