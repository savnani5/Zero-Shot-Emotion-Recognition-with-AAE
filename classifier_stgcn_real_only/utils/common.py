...
def get_affective_features(gaits):
    ...
    for sidx in range(num_samples):
        ...
        for tidx in range(num_tsteps):
            ...
            affective_features[sidx, tidx, fidx:fidx+30] = (np.dot(c*R, Xtx) + np.tile(
                np.reshape(t, (t.shape[0], 1)), (1, Xtx.shape[1]))).transpose().flatten()
            fidx += 30
            # within frame
            _0, _1, _2, _3, _4, _5, _6, _7, _8, _9 = get_joints(gaits, sidx, tidx)
            ...
            if tidx > 0:
                _0_1, _1_1, _2_1, _3_1, _4_1, _5_1, _6_1, _7_1,\
                    _8_1, _9_1 = get_joints(gaits, sidx, tidx-1)
